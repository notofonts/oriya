...
* 🔥 **FAIL** Not all fonts passed in the command line are in the same directory. This may lead to bad results as the tool will interpret all font files as belonging to a single font family. The detected directories are: ['fonts/NotoSansOriya/googlefonts/ttf', 'fonts/NotoSansOriya/googlefonts/variable-ttf'] [code: single-directory]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries:
 FONT_FAMILY_NAME = 'Noto Sans Oriya Black' / SUBFAMILY_NAME = 'Regular'
...
aiLengthcandraBinduoriya.umbrella, rephaiLengthcandraBinduoriya.stem and rephaiLengthcandraBinduoriya.umbrella [code: legacy-long-names]
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* six (U+0036): X=503.0,Y=716.0 (should be at cap-height 714?)

	* seven (U+0037): X=38.0,Y=713.0 (should be at cap-height 714?)

	* seven (U+0037): X=545.0,Y=713.0 (should be at cap-height 714?)
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* ampersand (U+0026): X=386.5,Y=-1.0 (should be at baseline 0?)

	* four (U+0034): X=323.0,Y=715.0 (should be at cap-height 714?)

	* four (U+0034): X=468.0,Y=715.0 (should be at cap-height 714?)

	* six (U+0036): X=492.0,Y=716.0 (should be at cap-height 714?)

	* seven (U+0037): X=42.0,Y=713.0 (should be at cap-height 714?)

	* seven (U+0037): X=534.0,Y=713.0 (should be at cap-height 714?)

	* C (U+0043): X=507.0,Y=712.5 (should be at cap-height 714?)

	* G (U+0047): X=542.5,Y=1.0 (should be at baseline 0?)

	* c (U+0063): X=404.5,Y=1.5 (should be at baseline 0?)

	* e (U+0065): X=438.0,Y=-0.5 (should be at baseline 0?) 
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* V (U+0056): B<<323.0,207.5>-<329.0,178.0>-<332.0,157.0>>/B<<332.0,157.0>-<334.0,178.0>-<340.0,207.0>> = 13.570434385161475

	* W (U+0057): B<<696.5,227.5>-<705.0,182.0>-<709.0,148.0>>/B<<709.0,148.0>-<712.0,172.0>-<718.5,206.5>> = 13.834853156658685

	* Wacute (U+1E82): B<<696.5,227.5>-<705.0,182.0>-<709.0,148.0>>/B<<709.0,148.0>-<712.0,172.0>-<718.5,206.5>> = 13.834853156658685

	* Wcircumflex (U+0174): B<<696.5,227.5>-<705.0,182.0>-<709.0,148.0>>/B<<709.0,148.0>-<712.0,172.0>-<718.5,206.5>> = 13.834853156658685

	* Wdieresis (U+1E84): B<<696.5,227.5>-<705.0,182.0>-<709.0,148.0>>/B<<709.0,148.0>-<712.0,172.0>-<718.5,206.5>> = 13.834853156658685
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* six (U+0036): X=468.0,Y=716.0 (should be at cap-height 714?)

	* question (U+003F): X=151.5,Y=712.0 (should be at cap-height 714?)
	...
	* t (U+0074): X=128.0,Y=659.0 (should be at x-height 658?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* two (U+0032) contains a short segment L<<155.0,76.0>--<155.0,74.0>>
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* uni0B76 (U+0B76): L<<367.0,235.0>--<368.0,238.0>> -> L<<368.0,238.0>--<471.0,556.0>> [code: found-colinear-vectors]
</div></details><details><summary>⚠ <b>WARN:</b> Do outlines contain any semi-vertical or semi-horizontal lines? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/<Section: Outline Correctness Checks>.html#com.google.fonts/check/outline_semi_vertical">com.google.fonts/check/outline_semi_vertical</a>)</summary><div>
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* exclam (U+0021): L<<167.0,174.0>--<165.0,714.0>>

	* exclam (U+0021): L<<193.0,714.0>--<191.0,174.0>>
